package com.ZakHolmes;//pretty much done, decide weather do an ai or not
...
public class NandCAI {
    ...
    public static void main(String[] args){
        //char[][] grid = {{'X','|','X','|','O'},{'-','+','-','+','-'},{'O','|','X','|','O'},{'-','+','-','+','-'},{' ','|',' ','|',' '}};//rows then cols
    ...
    public static int minimax(char[][] grid, boolean isMax,int depth){
        ...
        //printGrid(grid);
        if (winCheck(grid) != ' '){
            //System.out.println(winCheck(grid) + "WIN CHECK");
            //printGrid(grid);
            return evalPos(grid);
        }
        char aiTurn = 'O';
